...
def build_collection(chroma_dir: Path, collection_name: str, embedding_model: str) -> Any:
...
def main():
    ...
    collection = build_collection(chroma_dir, args.collection, args.embedding_model)
